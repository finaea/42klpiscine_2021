int	right_arg_1(char box[5][5], int row)
{
...
int	right_arg_2(char box[5][5], int row)
{
	if (box[row][3] == 4 || ((box[row][2] == 4 && (box[row][4] > box[row][3])))
...
int	right_arg_3(char box[5][5], int row)
{
...
int	right_arg_4(char box[5][5], int row)
{
...
int	crin(char *num, char box[5][5], int row)
{
	...
	else if (num[11 + row] == 2)
		return (right_arg_2(box, row));
	else if (num[11 + row] == 3)
